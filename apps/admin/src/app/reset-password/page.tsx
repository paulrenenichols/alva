          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2 pr-10 border rounded bg-bg-input text-text-primary border-border-default focus:outline-none focus:ring-2 focus:ring-primary-500 placeholder:text-text-tertiary"
                required
                minLength={8}
              />
              <button
