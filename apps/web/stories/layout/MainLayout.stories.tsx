    ...
    <MainLayout>
      <div className="p-8">
        ...
        <p className="text-text-secondary mb-6">
          ...
          a header, sidebar navigation, and this main content area.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="p-4 bg-bg-secondary rounded-md">
            ...
            <p className="text-text-secondary">
              See your latest marketing activities
            </p>
          </div>
          <div className="p-4 bg-bg-secondary rounded-md">
            <h3 className="font-semibold text-text-primary mb-2">
  ...
  render: () => (
    <MainLayout>
      <div className="p-8">
        ...
        <p className="text-text-secondary mb-6">
          This layout includes a collapsible sidebar for navigation. The sidebar
          can be toggled on mobile devices and provides easy access to all main
          sections.
        </p>
  ...
  render: () => (
    <MainLayout>
      <div className="p-4 md:p-8">
        ...
        <p className="text-text-secondary mb-6">
          This layout adapts to different screen sizes. The sidebar behavior
          changes based on the viewport width.
        </p>
