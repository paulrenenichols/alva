...
const meta: Meta<typeof Textarea> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A textarea component for multi-line text input with semantic styling and validation states.',
      },
    },
  },
  tags: ['autodocs'],
...
export const WithValue: Story = {
  args: {
    defaultValue: 'This is a sample textarea with some content. It demonstrates how the textarea looks with text.',
    placeholder: 'Enter your message...',
  },
};
...
export const AllStates: Story = {
  render: () => (
    <div className="space-y-4 w-96">
      <div>
        <label className="block text-sm font-medium text-text-primary mb-2">Default</label>
        <Textarea placeholder="Default textarea" />
      </div>
      
      <div>
        <label className="block text-sm font-medium text-text-primary mb-2">With Value</label>
        <Textarea defaultValue="This textarea has content" />
      </div>
      
      <div>
        <label className="block text-sm font-medium text-text-primary mb-2">Disabled</label>
        <Textarea placeholder="Disabled textarea" disabled />
      </div>
      
      <div>
        <label className="block text-sm font-medium text-text-primary mb-2">Error State</label>
...
export const Sizes: Story = {
  render: () => (
    <div className="space-y-4 w-96">
      <div>
        <label className="block text-sm font-medium text-text-primary mb-2">Small (2 rows)</label>
        <Textarea placeholder="Small textarea" rows={2} />
      </div>
      
      <div>
        <label className="block text-sm font-medium text-text-primary mb-2">Medium (4 rows)</label>
        <Textarea placeholder="Medium textarea" rows={4} />
      </div>
      
      <div>
        <label className="block text-sm font-medium text-text-primary mb-2">Large (6 rows)</label>
...
export const AccessibilityTest: Story = {
  render: () => (
    <div className="space-y-4 w-96">
      ...
      <div>
        <label htmlFor="accessible-textarea" className="block text-sm font-medium text-text-primary mb-2">
          Accessible Textarea
        </label>
        <Textarea 
