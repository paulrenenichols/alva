...
const meta: Meta<typeof ThemeToggle> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A theme toggle component that switches between light and dark modes with persistence.',
      },
    },
  },
  tags: ['autodocs'],
  ...
  render: () => (
    <div className="space-y-4">
      <div className="text-center">
        <h3 className="text-lg font-semibold mb-2 text-text-primary">Theme Toggle Demo</h3>
        <p className="text-text-secondary mb-4">
          Click the toggle to switch between light and dark themes. The theme preference is saved in localStorage.
        </p>
      </div>
  ...
  render: () => (
    <div className="space-y-4">
      ...
      <div className="text-sm text-text-tertiary">
        <p>Try using Tab to focus the toggle, then Enter or Space to activate it.</p>
      </div>
    </div>
  ),
};
